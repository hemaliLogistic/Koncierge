                        ...
                        <div className="react-custom-tabs">
                            <div className="react-custom-tabs-left">
                                <Tabs
                                    ...
                                    onSelect={(index) =>
                                        handleTabClick(index, categoryData[index])
                                    }
                                >
                                    <TabList>
                                    ...
                                    {categoryData.map((category, index) => (
                                        <TabPanel key={category.id || index}>
                                                            ...
                                                            <div className="tab-content-block-inner-left">
                                                                ...
                                                                <div className="checkbox-custom">
                                                                    <div className="checkbox-custom-inner">
                                                                        ...
                                                                        />
                                                                        <label
                                                                            htmlFor={`styled-checkbox-${service.id}`}
                                                                        ></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div
                                                className="total-cost-block justify-center items-center cursor pointer"
                                                data-aos="fade-up"
                                                data-aos-duration="1100"
