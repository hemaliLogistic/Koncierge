                        ...
                        <>
                            {filteredUserList?.map((message) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`flex pt-[20px]  ${isSelected ? "!bg-gray-400" : ""
                                                }`}
                                        >
                                            ...
                                            <div className="message-detail-container">
                                                <p
                                                    className={`message-username ${isSelected ? "text-white" : ""
                                                        }`}
                                                >
                                                    {message.adminName}
                                                </p>
                                                {message?.typeOfMessage !== "text" ? (
                                                    <p
                                                        className={`message-text ${isSelected ? "text-white" : ""
                                                            }`}
                                                    >
                                                        media
                                                    </p>
                                            ...
                                            <div className="time-detail-container">
                                                <p
                                                    className={`time-text  ${isSelected ? "text-white" : ""
                                                        }`}
                                                >
                                                    {formattedDate}
                                                </p>
