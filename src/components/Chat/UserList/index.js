...
const UserList = ({ chatIdRef, userList }) => {
                        ...
                        <>
                            {filteredUserList?.map((message) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`flex pt-[20px]  ${isSelected ? "!bg-gray-300" : ""
                                                }`}
                                        >
                                            ...
                                            <div className="message-detail-container">
                                                <p
                                                    className={`message-username ${isSelected ? "text-black" : ""
                                                        }`}
                                                >
                                                    {message.adminName}
                                                </p>
                                                {message?.typeOfMessage !== "text" ? (
                                                    <p
                                                        className={`message-text ${isSelected ? "text-black" : ""
                                                            }`}
                                                    >
                                                        media
                                                    </p>
                                            ...
                                            <div className="time-detail-container">
                                                <p
                                                    className={`time-text  ${isSelected ? "text-black" : ""
                                                        }`}
                                                >
                                                    {formattedDate}
                                                </p>
